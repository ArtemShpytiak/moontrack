<script>
	...
	postData("${pageContext.request.contextPath}/dashboard/widgets/get")
		.then(data => {
	...
	$("div#add-panel")
		...
		.click(function() {
			...
			postData(
				"${pageContext.request.contextPath}/dashboard/widgets/add",
				{ filter }
			)
				.then(data => {
					...
					if (widgetBox.length) {
						...
						console.log("id not found: " + data.tempMetricId);
					}
	...
	function setWidgetBoxData(widgetBox, data) {
		...
		btnRemove.on("click", () => {
			...
			const url =
				"${pageContext.request.contextPath}/dashboard/widgets/remove/" +
				data.widgetId;
			postData(url)
				.then(data => {
					console.log(data);
