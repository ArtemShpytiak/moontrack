...
public class Countries {
	...
	// TODO remove me w ip address utility
	private static Map<String, String> countries = Stream.of(new String[][] { { "AD", "Andorra" },
			...
			{ "CA", "Canada" }, { "CC", "Cocos (Keeling) Islands" }, { "CD", "Congo, Democratic Republic of" },
			...
			{ "MC", "Monaco" }, { "MD", "Moldova" }, { "ME", "Montenegro" }, { "MF", "Saint-Martin (France)" },
			...
			{ "SV", "El Salvador" }, { "SX", "Sint Maarten (Dutch part)" }, { "SY", "Syria" }, { "SZ", "Swaziland" },
			...
			{ "UZ", "Uzbekistan" }, { "VA", "Vatican" }, { "VC", "Saint Vincent and the Grenadines" },
			{ "VE", "Venezuela" }, { "VG", "Virgin Islands (British)" }, { "VI", "Virgin Islands (U.S.)" },
			{ "VN", "Vietnam" }, { "VU", "Vanuatu" }, { "WF", "Wallis and Futuna Islands" }, { "WS", "Samoa" },
