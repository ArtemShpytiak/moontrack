...
import com.moonmana.moontrack.metrics.charts.DpuChart;

import hive.model.filter.FilterHub;

public class Dpu extends MetricWithFilters {

	public Dpu(FilterHub filter) {
		super(filter);
	...
	public String getSQL() {
		return
		// @formatter:off
				" SELECT date_trunc('day', date) AS day, CAST(COUNT(DISTINCT iaps.r_user) AS INTEGER)" +
