...
public class InstallsDaily extends MetricWithFilters {

	public InstallsDaily(FilterHub filter) {
		super(filter);
		setType(MetricType.INSTALLS_DAILY);
	}
	...
	public String getSQL() {
		return
		// @formatter:off
				" SELECT date_trunc('day', d_user_registrations.registration_date) AS DAY, count(*)" +
